...
The verdict token must be the very first characters of your reply — no preamble, plan narration, or reasoning before it.
Your first line must be exactly one of:
- ALLOW: <short reason>
- BLOCK: <short reason>
Do not put anything before that first line.
Do not write ALLOW: or BLOCK: anywhere in your reply except on that single verdict line.
</compact_output_contract>
