...
Run a Grok Build review through the grok-companion review runtime.
...
- `/grok:review` reviews working-tree or branch diffs. It does not support staged-only review, unstaged-only review, or extra focus text.
